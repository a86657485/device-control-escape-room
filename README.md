...
18个操作任务、6个解释检查、三级提示、控制线索簿、终局任务单考核、报告导出、同伴机关设计。终局考核有16道情境题，四组各4题；后8题结合教材“拓展与提升”，提供设备发展阅读档案；学生通过点击选项和拼句完成，不要求长篇打字。教师已反馈旧版课堂完成过快，本次以情境、效果、观察与推理替代照指令选择。新版的学习时长与成效需结合下一次课堂再观察。
...
18个任务以情境和功能效果提出要求。失败反馈报告真实的模拟结果；每任务独立三级提示，具体操作帮助在试验后按需查看。终局题提交前不显示正误，保留首答与订正记录。没有强制等待或速度排名。
